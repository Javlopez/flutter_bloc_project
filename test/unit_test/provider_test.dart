import 'dart:io';
import 'package:bloc_project/src/models/item_model.dart';
//import 'package:bloc_project/src/models/trailer_model.dart';
import 'package:bloc_project/src/models/state.dart';
import 'package:bloc_project/src/models/trailer_model.dart';
import 'package:bloc_project/src/resources/movie_api_provider.dart';
...
void main() {
  group("MovieApiProvider test", () {
    test("fetchMovieList success test", () async {
      ...
      when(mockClient.get(
              "http://api.themoviedb.org/3/movie/popular?api_key=af9ae3997d25e9a6fa2ca1a11f73fc0e"))
    ...
    test("fetchTrailer success test", () async {
      ...
      var mockClient = app.mockClient;
      when(mockClient.get(
              "http://api.themoviedb.org/3/movie/420818/videos?api_key=af9ae3997d25e9a6fa2ca1a11f73fc0e"))
          .thenAnswer((_) async => http.Response(
    ...
    test("fetchTrailer fail test", () async {
      ...
      var mockClient = app.mockClient;
      when(mockClient.get(
              "http://api.themoviedb.org/3/movie/428/videos?api_key=af9ae3997d25e9a6fa2ca1a11f73fc0e"))
          .thenAnswer((_) async => http.Response(
